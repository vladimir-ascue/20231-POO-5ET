...
INSERT INTO `tflor` VALUES (1,'rosa','dulce','roja',34,100,'2023-02-28 17:02:00','Activo'),(2,'clavel','dulce','Verde',15,15,'2023-02-28 17:10:00','Activo');
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `actualizarFlor`(pidFlor int, pcolumna varchar(45), nuevoValor varchar(45)) RETURNS int
BEGIN
	DECLARE nvalor INT;
...
pnombre varchar(75),paroma varchar(45),
pcolor varchar(45),pprecio double,
pstock int,pfcreacion datetime,
pestado varchar(12)) RETURNS int
BEGIN
	INSERT INTO `bdfloreria`.`tflor`
		VALUES(0,pnombre,paroma,
		pcolor,pprecio,pstock,
        pfcreacion,pestado
		);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `crearUsuario`(
pnombre varchar(75),paroma varchar(45),
pcolor varchar(45),pprecio double,
pstock int,pfcreacion datetime,
pestado varchar(12)) RETURNS int
...
-- Dump completed on 2023-02-28 18:25:58
